...
| `qwen_image` | Wanx 2.1 (Alibaba) | ~$0.016-0.032 | ~10-20s | Budget-friendly, multilingual, style presets |
...
| **Budget-friendly generation** | `qwen_image` | Low cost, decent quality | `flux_image` |
